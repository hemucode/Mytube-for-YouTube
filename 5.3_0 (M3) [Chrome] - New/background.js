 ...
 */
const API_KEY = "AKfycbyjp1cYW2EYcbG2KBw_4DROIk-HWVuZJo9hzqAZkwxpzaDpL_WYqPzTqOkp0yG3UT1o";
...
async function disable() {
  await chrome.action.setIcon({
    path: {
      32: "data/icons/32_d.png",
      48: "data/icons/48_d.png",
      128: "data/icons/128_d.png"
    },
  });
 ...
 * rights only @codehemu.
 */
const setAdBlockingSelectors = async (adBlockingSelectors,isUpdatePopupEnabled,isRateUsPopupEnabled) => {
...
const updateJson = async () => {
  ...
  .then((json) => {
  	console.log(json);
  	 ...
  	 setAdBlockingSelectors(adBlockingSelector,isUpdatePopupEnabled,isRateUsPopupEnabled);
  	 //console.log(adBlockingSelector);
  })
  .catch((e) => {
    console.error(e);
   });

...
function linkButton() {
  document.querySelector('.teaser').href = `https://addons.mozilla.org/en-US/firefox/addon/mytube-youtube/`;
...
function mouseOver() {
  if (localStorage.message=="nyancat") {
    document.querySelector(".cta-message").innerText="Install Water Clock";
...
function linkopen(){
  if (localStorage.message=="nyancat") {
    window.open("https://www.codehemu.com/2022/04/water-clock.html",'_blank');
  }else{
